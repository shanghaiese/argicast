...
{
    public class SW_GroundSprayGenericClomazone
    {
        ...
        enum RuleNames
        {
            A1, A2, A3, A4, A5, B2, B3, C1, C2, C3, C4, E1
        ...
        private const string SW_GroundSprayGeneric_E1 = "E";
        ...
        private static string TrnsText_E1 = "ResLegEcesEvap";
        ...
        static private void IntialiseOutputDatatable()
        {
            ...
            DataColumn colDateTime = new DataColumn("day");
            colDateTime.DataType = System.Type.GetType("System.DateTime");
            dtOutput.Columns.Add(colDateTime);
        ...
        static private DataRow GetEndValues(int iHour)
        {
            ...
            //Get the Hour +3 data
            drColl = dtInputRaw.Select("" + DATE + "='" + dateLocal.AddHours(double.Parse(iHour.ToString())).ToString("yyyy-MM-dd HH:mm:ss") + "'");
        ...
        static private void GetOutputData()
        {
            ...
            drOutput["day"] = Convert.ToDateTime(drHour0[DATE]);
        ...
        static private string GetRestrictionLetter(string strRestName)
        {
            ...
            switch (strRestName)
            {
                ...
                case "C4": strLetter = SW_GroundSprayGeneric_C4;
                    break;
                case "E1": strLetter = SW_GroundSprayGeneric_E1;
                    break;
        ...
        static private string GetRestrictionTransTag(string sRes)
        {
            ...
            switch (sRes)
            {
                ...
                case "C4": strTransTag = TrnsText_C4;
                    break;
                case "E1": strTransTag = TrnsText_E1;
                    break;
