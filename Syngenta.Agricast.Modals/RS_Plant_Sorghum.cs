...
namespace Syngenta.Agricast.Modals
{
    public class RS_Plant_Sorghum
    {
        ...
        private const string RS_Plant_Sorghum_ResLegTooColdSoil = "A";
        private const string RS_Plant_Sorghum_ResLegRain = "R";
        private const string RS_Plant_Sorghum_ResRainExpected = "S";
        private const string RS_Plant_Sorghum_Default = "X";
        ...
        static private void GetOutputData(int index)
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = RS_Plant_Sorghum_Default;
                }
                else
                {
            ...
            while (startIndex_p <= endIndex_p)
            {
                ...
                if (!string.IsNullOrEmpty(strColorCode))
                {
                    ...
                    else
                    {
                        ...
                        dtOutput.Rows[index]["value"] = RS_Plant_Sorghum_ResLegRain;
        ...
        static private string GetRestrictionLetter(string strRest)
        {
            ...
            {
                strLetter = RS_Plant_Sorghum_ResLegTooColdSoil;
            }
            else if (strRest.Equals(strResLegRain))
            {
                strLetter = RS_Plant_Sorghum_ResLegRain;
            }
            else if (strRest.Equals(strResRainExpected))
            {
                strLetter = RS_Plant_Sorghum_ResRainExpected;
            }
