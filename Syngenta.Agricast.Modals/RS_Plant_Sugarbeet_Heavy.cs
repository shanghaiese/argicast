...
{
    public class RS_Plant_Sugarbeet_Heavy
    {
        ...
        public static DataTable RulesetSeriesList
        {
            get
            {
                ...
                RulesetSerieList.Rows.Add("MoistureSoilclay010cm");
        ...
        private const string RS_Plant_Sugarbeet_Heavy_ResLegTooColdSoil = "A";
        private const string RS_Plant_Sugarbeet_Heavy_ResLegTooColdSoil24 = "A";
        private const string RS_Plant_Sugarbeet_Heavy_ResLegTooColdSoil48 = "A";
        private const string RS_Plant_Sugarbeet_Heavy_ResLegTooColdSoil72 = "A";
        private const string RS_Plant_Sugarbeet_Heavy_ResLegTooWetGround = "M";
        private const string RS_Plant_Sugarbeet_Heavy_ResLegRain = "R";
        private const string RS_Plant_Sugarbeet_Heavy_ResLegRain24 = "R";
        private const string RS_Plant_Sugarbeet_Heavy_ResLegFrost = "C";
        private const string RS_Plant_Sugarbeet_Heavy_Default = "X";

        private static string PRECIP = "PrecipQuantity_hSum";
        private static string SOILTEMP = "soiltemp";
        private static string MOISTURESOIL_CLAY = "MoistureSoilclay010cm";
        ...
        static public DataTable CalculateRuleSets(IRuleSets objIRuleSets)
        {
            ...
            MOISTURESOIL_CLAY = getColumnName(dtInput.Columns, "MoistureSoilClay010cm");
        ...
        static private void CalcAllRules(int startIndex)
        {
            ...
            //<rule value="0" letter="R" adddescription="ResLegRain24">
            ...
            //<rule value="1" letter="C" adddescription="ResLegFrost" hourfrom="-12" hourto="11">
            //<!-- min ground level temp too low - FROST - warning 24 hrs previous-->
            //<condition decimaterule="min" column="temp_min5" interpolaterule="dailyto24" upper="0" />
            ...
            //ReferenceEquals TO CONDITION "fAvg_H24_MOISTURESOIL_CLAY"
            /*************************/
        ...
        static private void GetOutputData(int index)
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = RS_Plant_Sugarbeet_Heavy_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRest)
        {
            ...
            {
                strLetter = RS_Plant_Sugarbeet_Heavy_ResLegTooColdSoil;
            }
            else if (strRest.Equals(strResLegFrost))
            {
                strLetter = RS_Plant_Sugarbeet_Heavy_ResLegFrost;
            }
            else if (strRest.Equals(strResLegRain))
            {
                strLetter = RS_Plant_Sugarbeet_Heavy_ResLegRain;
            }
            else if (strRest.Equals(strResLegRain24))
            {
                strLetter = RS_Plant_Sugarbeet_Heavy_ResLegRain24;
            }
            else if (strRest.Equals(strResLegTooWetGround))
            {
                strLetter = RS_Plant_Sugarbeet_Heavy_ResLegTooWetGround;
            }
            else if (strRest.Equals(strResLegTooColdSoil24))
            {
                strLetter = RS_Plant_Sugarbeet_Heavy_ResLegTooColdSoil24; ;
            }
            else if (strRest.Equals(strResLegTooColdSoil48))
            {
                strLetter = RS_Plant_Sugarbeet_Heavy_ResLegTooColdSoil48;
            }
            else if (strRest.Equals(strResLegTooColdSoil72))
            {
                strLetter = RS_Plant_Sugarbeet_Heavy_ResLegTooColdSoil72;
            }
            return strLetter;
        }
        ...
        static private void CalcResLegRain(int startIndex, int endIndex)
        {
            ...
            if (isResLegRain)
            {
                ...
                UpdateOutputTable(startIndexTemp, startIndexTemp + 5, strResLegRain, RS_Plant_Sugarbeet_Heavy_ResLegRain, strCellValue);
                isResLegRain = false;
            }
        ...
        static private void CalcResLegFrost(int startIndex, int endIndex)
        {
            ...
            if (isResLegFrost)
            {
                ...
                UpdateOutputTable(startIndexTemp, startIndex + 10, strResLegFrost, RS_Plant_Sugarbeet_Heavy_ResLegFrost, strCellValue);
                isResLegFrost = false;
            }
        ...
        static private void CalcResLegTooWetGround(int startIndex, int endIndex)
        {
            ...
            double fAvg_H24_MoistureSoil_Clay = 0.0;
            ...
            //Get the Current Hour Data
            fAvg_H24_MoistureSoil_Clay = double.TryParse(dtInput.Rows[startIndexTemp][MOISTURESOIL_CLAY].ToString(), out i) ? i : 0;



            if (fAvg_H24_MoistureSoil_Clay > 0.0)
            {
            ...
            {
                strCellValue = "0";//High Risk
                UpdateOutputTable(startIndexTemp, startIndexTemp + 23, strResLegTooWetGround, RS_Plant_Sugarbeet_Heavy_ResLegTooWetGround, strCellValue);
                isResLegTooWetGround = false;
            }

            //Clear the Values in all the place holders
            fAvg_H24_MoistureSoil_Clay = 0.0f;
