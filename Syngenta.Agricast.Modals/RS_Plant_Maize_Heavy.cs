...
{
    public class RS_Plant_Maize_Heavy
    {
        ...
        private const string RS_Plant_Maize_Heavy_ResLegTooColdSoil = "A";
        private const string RS_Plant_Maize_Heavy_ResLegTooWetGround = "M";
        private const string RS_Plant_Maize_Heavy_ResLegRain = "R";
        private const string RS_Plant_Maize_Heavy_Default = "X";
        ...
        static public DataTable CalculateRuleSets(IRuleSets objIRuleSets)
        {
            ...
            TEMP = getColumnName(dtInput.Columns, "soilTemp");
        ...
        static private void CalcAllRules(int startIndex)
        {
            ...
            // float fAvg_H24_MoistureSoil_Clay = float.Parse(resHours_24.ToList()[0].dtAvgMoistureSoilClay.ToString());//Fetch the Avg of data (hour 0 to 24) 
        ...
        static private void GetOutputData(int index)
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = RS_Plant_Maize_Heavy_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRest)
        {
            ...
            {
                strLetter = RS_Plant_Maize_Heavy_ResLegTooColdSoil;
            }
            else if (strRest.Equals(strResLegRain))
            {
                strLetter = RS_Plant_Maize_Heavy_ResLegRain;
            }
            else if (strRest.Equals(strResLegTooWetGround))
            {
                strLetter = RS_Plant_Maize_Heavy_ResLegTooWetGround;
            }
        ...
        static private void CalcResLegTooWetGround(int startIndex, int endIndex)
        {
            ...
            if (fAvg_H24_MoistureSoil_Clay > 40.0)
            {
            ...
            if (isResLegTooWetGround)
            {
                ...
                UpdateOutputTable(startIndexTemp, startIndexTemp + 23, strResLegTooWetGround, RS_Plant_Maize_Heavy_ResLegTooWetGround);
                isResLegTooWetGround = false;
            }
        ...
        static private void CalcResLegRain(int startIndex, int endIndex)
        {
            ...
            {
                strCellValue = "0";//High Risk
                UpdateOutputTable(startIndexTemp, startIndexTemp + 5, strResLegRain, RS_Plant_Maize_Heavy_ResLegRain);
                isResLegRain = false;
            }
