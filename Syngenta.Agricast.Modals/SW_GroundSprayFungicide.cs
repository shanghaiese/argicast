...
/// <summary>
/// Summary description for SW_GroundSprayFungicide
/// </summary>
namespace Syngenta.Agricast.Modals
{
    public class SW_GroundSprayFungicide
    {
        ...
        #region Constants
        private const string SW_GroundSprayFungicide_A5 = "R";
        private const string SW_GroundSprayFungicide_A4 = "A";
        private const string SW_GroundSprayFungicide_A3 = "A";
        private const string SW_GroundSprayFungicide_C4 = "D";
        private const string SW_GroundSprayFungicide_A2 = "F";
        private const string SW_GroundSprayFungicide_A1 = "F";
        private const string SW_GroundSprayFungicide_B2 = "U";
        private const string SW_GroundSprayFungicide_B3 = "V";
        private const string SW_GroundSprayFungicide_C3 = "D";
        private const string SW_GroundSprayFungicide_C1 = "T";
        private const string SW_GroundSprayFungicide_C2 = "T";
        private const string SW_GroundSprayFungicide_Default = "X";
        ...
        /// <returns>
        /// Output table with DateLocal,hour,value,color,letter and restrictions 
        /// </returns>
        static private DataTable ApplyRules()
        {

            //Get The Count of Input Datatable
            ...
            for (int i = 0; i < dtInput.Rows.Count; i++)
            {
                ...
                if (dataPresent)
                {
                    ...
                    //Apply rules for PrecipQuantity_hSumition
                    CalcRulesForPrecipQuantity_hSum();

                    //Apply rules for HumidityRelity
                    CalcRulesForHumidityRelity();

                    //Apply rules for WindSpeed    
                    CalcRulesForWindSpeed();

                    //Apply Rules for WindGustSpeed_hMax
        ...
        /// <summary>
        /// Applies all the rules related to input- PrecipQuantity_hSumition 
        /// </summary>
        ...
        static private void CalcRulesForPrecipQuantity_hSum()
        {
            ...
            #region PrecipQuantity_hSumitation - Pre Application
            //A4 - Leaves too wet, risk of product run off	
            //Condition - PrecipQuantity_hSumAmount mm 	> 0 / hour -->(Hour -1)
            ...
            //Condition = PrecipQuantity_hSumAmount mm 	> 0 / hour 
            //Check for Hour - 2
            ...
            #region PrecipQuantity_hSumitation- Application Hour(h0)
            //A5 - PrecipQuantity_hSumitation after application,  risk of product run off	
            //conditions -PrecipQuantity_hSumAmount > 0 hour0, 
            ...
            #region PrecipQuantity_hSumitation - Post Application
            //A5 - PrecipQuantity_hSumitation after application,  risk of product run off	
            //conditions -PrecipQuantity_hSumAmount > 0 hour + 1,hour + 2 
            ...
            //A5 - PrecipQuantity_hSumitation after application,  risk of product run off	
            //conditions -PrecipQuantity_hSumAmount > 2 Hour + 3, 
        ...
        static private void CalcRulesForWindGustSpeed_hMax()
        {
            ...
            //condtion :- WindGustSpeed_hMax m/s 	> = 5
            if (!string.IsNullOrEmpty(fHour0))
            {
        ...
        /// <summary>
        ///  Applies all the rules related to input- HumidityRelity 
        /// </summary>
        /// <param name="fHour_M1"></param>
        /// <param name="fHour0"></param>
        /// <param name="fHour_P1"></param>
        ...
        static private void CalcRulesForHumidityRelity()
        {
            ...
            #region HumidityRelity - PreApplication
            //A3 - Leaves wet, risk of product run off	
            //Condtion :- HumidityRelityRel % = 100 (hour -1)
            if (!string.IsNullOrEmpty(fHour_M1))
            {
            ...
            #region HumidityRelity - Applicaition Hour(H0)

            //A4 - Leaves too wet, risk of product run off
            //Condition:=HumidityRelityRel % = 100 (Application Hour)
            if (!string.IsNullOrEmpty(fHour0))
            {
            ...
            //A3 - Leaves wet, risk of product run off	
            //HumidityRelityRel %> 87 at Application Hour
            if (!string.IsNullOrEmpty(fHour0))
            {
            ...
            //A2 - Relative HumidityRelity low, risk of droplet evaporation	
            //condition :- HumidityRelityRel % 	30 < x <= 50
            if (!string.IsNullOrEmpty(fHour0))
            {
            ...
            //A1 - Relative HumidityRelity too low, risk of droplet evaporation	
            //condition :- HumidityRelityRel % 	<= 30
            if (!string.IsNullOrEmpty(fHour0))
            {
            ...
            #region HumidityRelity - Post Application

            //A4 - Leaves too wet, risk of product run off
            //Condition:=HumidityRelityRel % = 100 (Application Hour)
            // HumidityRelityRel % = 100(hour + 1 or hour + 2)
            if (!string.IsNullOrEmpty(fHour_P1))
                fHrP1 = float.Parse(fHour_P1);
            if (!string.IsNullOrEmpty(fHour_P2))
                fHrP2 = float.Parse(fHour_P2);
        ...
        static private void GetOutputData()
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = SW_GroundSprayFungicide_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRestName)
        {
            ...
            switch (strRestName)
            {
                case "A1": strLetter = SW_GroundSprayFungicide_A1;
                    break;
                case "A2": strLetter = SW_GroundSprayFungicide_A2;
                    break;
                case "A3": strLetter = SW_GroundSprayFungicide_A3;
                    break;
                case "A4": strLetter = SW_GroundSprayFungicide_A4;
                    break;
                case "A5": strLetter = SW_GroundSprayFungicide_A5;
                    break;
                case "B2": strLetter = SW_GroundSprayFungicide_B2;
                    break;
                case "B3": strLetter = SW_GroundSprayFungicide_B3;
                    break;
                case "C1": strLetter = SW_GroundSprayFungicide_C1;
                    break;
                case "C2": strLetter = SW_GroundSprayFungicide_C2;
                    break;
                case "C3": strLetter = SW_GroundSprayFungicide_C3;
                    break;
                case "C4": strLetter = SW_GroundSprayFungicide_C4;
                    break;
                default: strLetter = SW_GroundSprayFungicide_Default;
                    break;
            }
