...
{
    public class RS_Plant_Sugarbeet_Medium
    {
        ...
        public static DataTable RulesetSeriesList
        {
            get
            {
                ...
                RulesetSerieList.Rows.Add("MoistureSoilSilt010cm");
        ...
        private const string RS_Plant_Sugarbeet_Medium_ResLegTooColdSoil = "A";
        private const string RS_Plant_Sugarbeet_Medium_ResLegTooColdSoil24 = "A";
        private const string RS_Plant_Sugarbeet_Medium_ResLegTooColdSoil48 = "A";
        private const string RS_Plant_Sugarbeet_Medium_ResLegTooColdSoil72 = "A";
        private const string RS_Plant_Sugarbeet_Medium_ResLegTooWetGround = "M";
        private const string RS_Plant_Sugarbeet_Medium_ResLegRain = "R";
        private const string RS_Plant_Sugarbeet_Medium_ResLegRain24 = "R";
        private const string RS_Plant_Sugarbeet_Medium_ResLegFrost = "C";
        private const string RS_Plant_Sugarbeet_Medium_Default = "X";

        private static string PRECIP = "PrecipQuantity_hSum";
        private static string SOILTEMP = "soiltemp";
        private static string MOISTURESOIL_SILT = "MoistureSoilSilt010cm";
        ...
        private static string strResLegRain24 = "ResLegRain24";
        ...
        static public DataTable CalculateRuleSets(IRuleSets objIRuleSets)
        {
            ...
            MOISTURESOIL_SILT = getColumnName(dtInput.Columns, "MoistureSoilSilt010cm");
        ...
        static private void InterPolateValues()
        {
            ...
            foreach (var r in res)
            {
                ...
                {
                    if (!string.IsNullOrEmpty(drArrayTemp[i][MOISTURESOIL_SILT].ToString()))
                    {
                        fMoistureSilt = float.Parse(drArrayTemp[i][MOISTURESOIL_SILT].ToString());
                        break;
                    }
                }
                ...
                for (int i = 0; i < drArrayTemp.Length; i++)
                {
                    ...
                    drArrayTemp[i][MOISTURESOIL_SILT] = fMoistureSilt;
        ...
        static private void CalcAllRules(int startIndex)
        {
            ...
            var result_F0_T24 = from dt in dtInputRaw.AsEnumerable()
                                ...
                                select new
                                {
                                    ...
                                    //dtAvgMoistureSoilSilt = grp.Average(t => double.TryParse(t[MOISTURESOIL_SILT].ToString(), out i) ? i : 0.0),
                                    dtAvgTemp = grp.Average(t => double.TryParse(t[SOILTEMP].ToString(), out i) ? i : 0.0),
                                    dtSumPrecip = grp.Average(t => double.TryParse(t[SOILTEMP].ToString(), out i) ? i : 0.0)
                                };



            //Fetch the Sum of Precip data (hour 0 to 24) 
            float fSum_H24_Precip = float.Parse(result_F0_T24.ToList()[0].dtSumPrecip.ToString());
            //<!--precip expected - cannot plant -->
            //<condition start="0" end="24" decimaterule="sum" column="precip" lower="20" />
            if (fSum_H24_Precip > 20.0)
            {
            ...
            //ReferenceEquals TO CONDITION "fAvg_H24_MOISTURESOIL_SILT"
            /*************************/
        ...
        static private void GetOutputData(int index)
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = RS_Plant_Sugarbeet_Medium_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRest)
        {
            ...
            {
                strLetter = RS_Plant_Sugarbeet_Medium_ResLegTooColdSoil;
            }
            else if (strRest.Equals(strResLegFrost))
            {
                strLetter = RS_Plant_Sugarbeet_Medium_ResLegFrost;
            }
            else if (strRest.Equals(strResLegRain))
            {
                strLetter = RS_Plant_Sugarbeet_Medium_ResLegRain;
            }
            else if (strRest.Equals(strResLegRain24))
            {
                strLetter = RS_Plant_Sugarbeet_Medium_ResLegRain24;
            }
            else if (strRest.Equals(strResLegTooWetGround))
            {
                strLetter = RS_Plant_Sugarbeet_Medium_ResLegTooWetGround;
            }
            else if (strRest.Equals(strResLegTooColdSoil24))
            {
                strLetter = RS_Plant_Sugarbeet_Medium_ResLegTooColdSoil24; ;
            }
            else if (strRest.Equals(strResLegTooColdSoil48))
            {
                strLetter = RS_Plant_Sugarbeet_Medium_ResLegTooColdSoil48;
            }
            else if (strRest.Equals(strResLegTooColdSoil72))
            {
                strLetter = RS_Plant_Sugarbeet_Medium_ResLegTooColdSoil72;
            }
            return strLetter;
        }
        ...
        static private void CalcResLegRain(int startIndex, int endIndex)
        {
            ...
            if (isResLegRain)
            {
                ...
                UpdateOutputTable(startIndexTemp, startIndexTemp + 5, strResLegRain, RS_Plant_Sugarbeet_Medium_ResLegRain, strCellValue);
                isResLegRain = false;
            }
        ...
        static private void CalcResLegFrost(int startIndex, int endIndex)
        {
            ...
            if (isResLegFrost)
            {
                ...
                UpdateOutputTable(startIndexTemp, startIndex + 10, strResLegFrost, RS_Plant_Sugarbeet_Medium_ResLegFrost, strCellValue);
                isResLegFrost = false;
            }
        ...
        static private void CalcResLegTooWetGround(int startIndex, int endIndex)
        {
            ...
            double fAvg_H24_MoistureSoil_Silt = 0.0;
            ...
            //Get the Current Hour Data
            fAvg_H24_MoistureSoil_Silt = double.TryParse(dtInput.Rows[startIndexTemp][MOISTURESOIL_SILT].ToString(), out i) ? i : 0;



            if (fAvg_H24_MoistureSoil_Silt > 30.0)
            {
            ...
            {
                strCellValue = "0";//High Risk
                UpdateOutputTable(startIndexTemp, startIndexTemp + 23, strResLegTooWetGround, RS_Plant_Sugarbeet_Medium_ResLegTooWetGround, strCellValue);
                isResLegTooWetGround = false;
            }


            //Clear the Values in all the place holders
            fAvg_H24_MoistureSoil_Silt = 0.0f;
