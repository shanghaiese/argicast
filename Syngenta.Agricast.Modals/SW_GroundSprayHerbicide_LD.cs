...
{
    public class SW_GroundSprayHerbicide_LD
    {
        ...
        enum RuleNames
        {
            A1, A2, A3, A4, A5, B2, B3, C1, C2, C3, C4, B1

        }

        #endregion

        #region Constants : - SW_GroundSprayHerbicide - Large DropLets
        //Constants to Letter for Rules in the RuleSet 

        private const string SW_GroundSprayHerbicide_LD_A5 = "R";
        private const string SW_GroundSprayHerbicide_LD_A4 = "A";
        private const string SW_GroundSprayHerbicide_LD_A3 = "A";
        private const string SW_GroundSprayHerbicide_LD_C4 = "D";
        private const string SW_GroundSprayHerbicide_LD_A2 = "F";
        private const string SW_GroundSprayHerbicide_LD_A1 = "U";
        private const string SW_GroundSprayHerbicide_LD_B1 = "U";
        private const string SW_GroundSprayHerbicide_LD_B2 = "U";
        private const string SW_GroundSprayHerbicide_LD_B3 = "V";
        private const string SW_GroundSprayHerbicide_LD_C3 = "D";
        private const string SW_GroundSprayHerbicide_LD_C1 = "T";
        private const string SW_GroundSprayHerbicide_LD_C2 = "T";
        private const string SW_GroundSprayHerbicide_LD_Default = "X";
        ...
        {
            //Set the Hourly Data of Wind speed
        ...
        static private void GetOutputData()
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = SW_GroundSprayHerbicide_LD_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRestName)
        {
            ...
            switch (strRestName)
            {
                case "A1": strLetter = SW_GroundSprayHerbicide_LD_A1;
                    break;
                case "A2": strLetter = SW_GroundSprayHerbicide_LD_A2;
                    break;
                case "A3": strLetter = SW_GroundSprayHerbicide_LD_A3;
                    break;
                case "A4": strLetter = SW_GroundSprayHerbicide_LD_A4;
                    break;
                case "A5": strLetter = SW_GroundSprayHerbicide_LD_A5;
                    break;
                case "B1": strLetter = SW_GroundSprayHerbicide_LD_B1;
                    break;
                case "B2": strLetter = SW_GroundSprayHerbicide_LD_B2;
                    break;
                case "B3": strLetter = SW_GroundSprayHerbicide_LD_B3;
                    break;
                case "C1": strLetter = SW_GroundSprayHerbicide_LD_C1;
                    break;
                case "C2": strLetter = SW_GroundSprayHerbicide_LD_C2;
                    break;
                case "C3": strLetter = SW_GroundSprayHerbicide_LD_C3;
                    break;
                case "C4": strLetter = SW_GroundSprayHerbicide_LD_C4;
                    break;
                default: strLetter = SW_GroundSprayHerbicide_LD_Default;
                    break;
            }
