...
{
    public class SW_GroundSprayHerbicide_SD
    {
        ...
        #region Constants : - SW_GroundSprayHerbicide - Small DropLets

        //Constants to Letter for Rules in the RuleSet 

        private const string SW_GroundSprayHerbicide_SD_A5 = "R";
        private const string SW_GroundSprayHerbicide_SD_A4 = "A";
        private const string SW_GroundSprayHerbicide_SD_A3 = "A";
        private const string SW_GroundSprayHerbicide_SD_C4 = "D";
        private const string SW_GroundSprayHerbicide_SD_A2 = "F";
        private const string SW_GroundSprayHerbicide_SD_A1 = "U";
        private const string SW_GroundSprayHerbicide_SD_B1 = "U";
        private const string SW_GroundSprayHerbicide_SD_B2 = "U";
        private const string SW_GroundSprayHerbicide_SD_B3 = "V";
        private const string SW_GroundSprayHerbicide_SD_C3 = "D";
        private const string SW_GroundSprayHerbicide_SD_C1 = "T";
        private const string SW_GroundSprayHerbicide_SD_C2 = "T";
        private const string SW_GroundSprayHerbicide_SD_Default = "X";
        ...
        #endregion Constants : - SW_GroundSprayHerbicide - Small DropLets
        ...
        static private void GetOutputData()
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = SW_GroundSprayHerbicide_SD_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRestName)
        {
            ...
            switch (strRestName)
            {
                case "A1": strLetter = SW_GroundSprayHerbicide_SD_A1;
                    break;
                case "A2": strLetter = SW_GroundSprayHerbicide_SD_A2;
                    break;
                case "A3": strLetter = SW_GroundSprayHerbicide_SD_A3;
                    break;
                case "A4": strLetter = SW_GroundSprayHerbicide_SD_A4;
                    break;
                case "A5": strLetter = SW_GroundSprayHerbicide_SD_A5;
                    break;
                case "B1": strLetter = SW_GroundSprayHerbicide_SD_B1;
                    break;
                case "B2": strLetter = SW_GroundSprayHerbicide_SD_B2;
                    break;
                case "B3": strLetter = SW_GroundSprayHerbicide_SD_B3;
                    break;
                case "C1": strLetter = SW_GroundSprayHerbicide_SD_C1;
                    break;
                case "C2": strLetter = SW_GroundSprayHerbicide_SD_C2;
                    break;
                case "C3": strLetter = SW_GroundSprayHerbicide_SD_C3;
                    break;
                case "C4": strLetter = SW_GroundSprayHerbicide_SD_C4;
                    break;
                default: strLetter = SW_GroundSprayHerbicide_SD_Default;
                    break;
            }
