...
{
    public class RS_Harvest_SugarBeet_Light
    {
        ...
        private const string RS_Harvest_Light_SugarBeet_ResLegTooWetSoilPrecip48 = "M";
        private const string RS_Harvest_Light_SugarBeet_ResLegRain24 = "R";
        private const string RS_Harvest_Light_SugarBeet_ResLegTooColdSoil = "C";
        private const string RS_Harvest_Light_SugarBeet_ResLegTooColdSoil48 = "C";
        private const string RS_Harvest_Light_SugarBeet_Default = "X";

        private static string PRECIP = "PrecipQuantity_hSum";
        private static string SOILTEMP = "soiltemp";
        private static string MOISTURESOIL_SAND = "MoistureSoilSand030cm";
        ...
        static public DataTable CalculateRuleSets(IRuleSets objIRuleSets)
        {
            ...
            MOISTURESOIL_SAND = getColumnName(dtInput.Columns, "MoistureSoilSand030cm");
        ...
        static private void CalcAllRules(int startIndex)
        {
            ...
            double fCurrHour_SoilSand = double.Parse(dtInput.Rows[startIndex][MOISTURESOIL_SAND].ToString());
            ...
            //                <condition start="-48" end="0" decimaterule="sum" column="precip" lower="20" />
            //            </rule>

            if (fCurrHour_SoilSand > 99 || fSum_H48_T0_Precip > 20.0)
            {
            ...
            //</rule>
            if (fCurrHour_SoilSand > 99 ||
                (fSum_H48_T0_Precip > 1 && fSum_H48_T0_Precip <= 20))
            {
        ...
        static private void GetOutputData(int index)
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = RS_Harvest_Light_SugarBeet_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRest)
        {
            ...
            {
                strLetter = RS_Harvest_Light_SugarBeet_ResLegRain24;
            }
            else if (strRest.Equals(strResLegTooColdSoil))
            {
                strLetter = RS_Harvest_Light_SugarBeet_ResLegTooColdSoil;
            }
            else if (strRest.Equals(strResLegTooColdSoil48))
            {
                strLetter = RS_Harvest_Light_SugarBeet_ResLegTooColdSoil48;
            }

            else if (strRest.Equals(strResLegTooWetSoilPrecip48))
            {
                strLetter = RS_Harvest_Light_SugarBeet_ResLegTooWetSoilPrecip48;
            }
