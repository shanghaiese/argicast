...
{
    public class SW_GroundSprayHerbicide_PE
    {
        ...
        enum RuleNames
        {
            A1, A2, A3, A4, A5, A6, B2, B3, C1, C2, C3, C4, B1

        }

        #endregion

        #region Constants : - SW_GroundSprayHerbicide - Pre Emergence
        //Constants to Letter for Rules in the RuleSet 

        private const string SW_GroundSprayHerbicide_PE_A6 = "A";
        private const string SW_GroundSprayHerbicide_PE_A5 = "R";
        private const string SW_GroundSprayHerbicide_PE_A4 = "A";
        private const string SW_GroundSprayHerbicide_PE_A3 = "A";
        private const string SW_GroundSprayHerbicide_PE_C4 = "D";
        private const string SW_GroundSprayHerbicide_PE_A2 = "F";
        private const string SW_GroundSprayHerbicide_PE_A1 = "U";
        private const string SW_GroundSprayHerbicide_PE_B1 = "U";
        private const string SW_GroundSprayHerbicide_PE_B2 = "U";
        private const string SW_GroundSprayHerbicide_PE_B3 = "V";
        private const string SW_GroundSprayHerbicide_PE_C3 = "D";
        private const string SW_GroundSprayHerbicide_PE_C1 = "T";
        private const string SW_GroundSprayHerbicide_PE_C2 = "T";
        private const string SW_GroundSprayHerbicide_PE_Default = "X";
        ...
        private static string TrnsText_A6 = "ResLegTooWet";
        ...
        #endregion Constants : - SW_GroundSprayHerbicide - Pre Emergence
        ...
        static private void CalcRulesForPrecipQuantity_hSum()
        {
            ...
            float fHrM1 = float.MinValue;
            float fHrM2 = float.MinValue;
            ...
            //A6 - Soil moisture high, risk of product leaching
            //Condition - precipAmount mm 	>=5 / hour - 1 -->(Hour - 2)
            if (!string.IsNullOrEmpty(fHour_M1))
                fHrM1 = float.Parse(fHour_M1);
            if (!string.IsNullOrEmpty(fHour_M2))
                fHrM2 = float.Parse(fHour_M2);
            ...
            if (fHrM1 >= 5 || fHrM2 >= 5)
            {
                ...
                if (!CheckRestrictioninList(RuleNames.A6.ToString()))
                {
                    //check if this is the first one to be added
                    if (strRestrictionList.Length == 0)
                        strRestrictionList = RuleNames.A6.ToString();
                    else
                        strRestrictionList = strRestrictionList + "," + RuleNames.A6.ToString();
                }
            ...
            //A6 - Soil moisture high, risk of product leaching
            //Condition - precipAmount mm 	>=5 / hour -->(Hour -1)
        ...
        static private void CalcRulesForWindSpeed()
        {
            ...
            //B1 - Windspeed too high, risk of drift

            //Condition:- windspeed m/s 	> 3
            if (!string.IsNullOrEmpty(fHour0))
            {
                if (float.Parse(fHour0) > 3)
                {
                    if (!CheckRestrictioninList(RuleNames.B1.ToString()))
                    {

                        if (strRestrictionList.Length == 0)
                            strRestrictionList = RuleNames.B1.ToString();
                        else
                            strRestrictionList = strRestrictionList + "," + RuleNames.B1.ToString();
                    }
        ...
        static private void GetOutputData()
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = SW_GroundSprayHerbicide_PE_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRestName)
        {
            ...
            switch (strRestName)
            {
                case "A1": strLetter = SW_GroundSprayHerbicide_PE_A1;
                    break;
                case "A2": strLetter = SW_GroundSprayHerbicide_PE_A2;
                    break;
                case "A3": strLetter = SW_GroundSprayHerbicide_PE_A3;
                    break;
                case "A4": strLetter = SW_GroundSprayHerbicide_PE_A4;
                    break;
                case "A5": strLetter = SW_GroundSprayHerbicide_PE_A5;
                    break;
                case "A6": strLetter = SW_GroundSprayHerbicide_PE_A6;
                    break;
                case "B1": strLetter = SW_GroundSprayHerbicide_PE_B1;
                    break;
                case "B2": strLetter = SW_GroundSprayHerbicide_PE_B2;
                    break;
                case "B3": strLetter = SW_GroundSprayHerbicide_PE_B3;
                    break;
                case "C1": strLetter = SW_GroundSprayHerbicide_PE_C1;
                    break;
                case "C2": strLetter = SW_GroundSprayHerbicide_PE_C2;
                    break;
                case "C3": strLetter = SW_GroundSprayHerbicide_PE_C3;
                    break;
                case "C4": strLetter = SW_GroundSprayHerbicide_PE_C4;
                    break;
                default: strLetter = SW_GroundSprayHerbicide_PE_Default;
                    break;
            }
        ...
        static private string GetRestrictionTransTag(string sRes)
        {
            ...
            switch (sRes)
            {
                ...
                case "A5": strTransTag = TrnsText_A5;
                    break;
                case "A6": strTransTag = TrnsText_A6;
                    break;
                case "B1": strTransTag = TrnsText_B1;
                    break;
