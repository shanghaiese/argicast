...
{
    public class SW_GroundSprayVineAndTree
    {
        ...
        #region Constants : - SW_GroundSpray- Vine And Tree Crops

        //Constants to Letter for Rules in the RuleSet 

        private const string SW_GroundSprayVineAndTree_A5 = "R";
        private const string SW_GroundSprayVineAndTree_A4 = "A";
        private const string SW_GroundSprayVineAndTree_A3 = "A";
        private const string SW_GroundSprayVineAndTree_C4 = "D";
        private const string SW_GroundSprayVineAndTree_A2 = "F";
        private const string SW_GroundSprayVineAndTree_A1 = "F";
        private const string SW_GroundSprayVineAndTree_B1 = "U";
        private const string SW_GroundSprayVineAndTree_B2 = "U";
        private const string SW_GroundSprayVineAndTree_B3 = "V";
        private const string SW_GroundSprayVineAndTree_C3 = "D";
        private const string SW_GroundSprayVineAndTree_C1 = "T";
        private const string SW_GroundSprayVineAndTree_C2 = "T";
        private const string SW_GroundSprayVineAndTree_Default = "X";
        ...
        #endregion Constants : - SW_GroundSpray - Vine And Tree Crops
        ...
        static private void GetOutputData()
        {
            ...
            if (strRestList != null)
            {
                ...
                {
                    drOutput["value"] = SW_GroundSprayVineAndTree_Default;
                }
                else
                {
        ...
        static private string GetRestrictionLetter(string strRestName)
        {
            ...
            switch (strRestName)
            {
                case "A1": strLetter = SW_GroundSprayVineAndTree_A1;
                    break;
                case "A2": strLetter = SW_GroundSprayVineAndTree_A2;
                    break;
                case "A3": strLetter = SW_GroundSprayVineAndTree_A3;
                    break;
                case "A4": strLetter = SW_GroundSprayVineAndTree_A4;
                    break;
                case "A5": strLetter = SW_GroundSprayVineAndTree_A5;
                    break;
                case "B1": strLetter = SW_GroundSprayVineAndTree_B1;
                    break;
                case "B2": strLetter = SW_GroundSprayVineAndTree_B2;
                    break;
                case "B3": strLetter = SW_GroundSprayVineAndTree_B3;
                    break;
                case "C1": strLetter = SW_GroundSprayVineAndTree_C1;
                    break;
                case "C2": strLetter = SW_GroundSprayVineAndTree_C2;
                    break;
                case "C3": strLetter = SW_GroundSprayVineAndTree_C3;
                    break;
                case "C4": strLetter = SW_GroundSprayVineAndTree_C4;
                    break;
                default: strLetter = SW_GroundSprayVineAndTree_Default;
                    break;
            }
