...
// Modified By: MOHAN P
//
// Purpose    : To catch an exception if there is any problem in Readinga  file
//
#endregion
	...
	public class FileAppender : TextWriterAppender 
	{
		...
		virtual protected void SafeOpenFile(string fileName, bool append)
		{
			...
			catch(Exception e) 
			{
                ...
                //BEGIN ADDED FOR RMS TO CATCH AN EXCEPTION BY MOHAN ON 26-JUL-07
                CustomError = "Error in Opening File or Writing exceptiong into the File";
                //END ADDED FOR RMS TO CATCH AN EXCEPTION BY MOHAN ON 26-JUL-07
			}
		}
