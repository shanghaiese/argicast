...
// Modified By: MOHAN P
//
// Purpose    : To catch an exception if there is any problem in connecting to database
//
#endregion
...
namespace log4net.Appender
{
	...
	public class AdoNetAppender : BufferingAppenderSkeleton
	{
		...
		override protected void SendBuffer(LoggingEvent[] events)
		{
            ...
            {
                // Can't insert into the database. That's a bad thing
                ErrorHandler.Error("Exception while writing to database : connection is worng");
                //BEGIN ADDED FOR RMS TO CATCH AN EXCEPTION BY MOHAN ON 25-JUL-07
                CustomError = "DB Error Occured";
                //END ADDED FOR RMS TO CATCH AN EXCEPTION BY MOHAN ON 25-JUL-07
            }
		}
